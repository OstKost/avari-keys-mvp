...
- **[TASK-001](./tasks/TASK-001-project-scaffolding.md)**: Базовый каркас проекта, Go-модули, Makefile, Frontend scaffold.
...
- **[TASK-003](./tasks/TASK-003-master-backend-auth-db.md)**: Master Backend — SQLite хранилище, регистрация, модерация админом, JWT сессии.
...
- **[TASK-007](./tasks/TASK-007-deployment-and-docs.md)**: Документация развертывания, Caddy/Nginx reverse proxy конфиги, systemd unit-файлы.

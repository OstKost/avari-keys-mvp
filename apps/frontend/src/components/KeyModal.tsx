        ...
        {isValidConfig ? (
          ...
          <div className="bg-amber-950/30 border border-amber-500/40 rounded-2xl p-4 mb-5 text-amber-200">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-xs sm:text-sm space-y-1.5 font-sans">
        ...
        {isValidConfig ? (
          ...
          <div className="mb-6">
            <button
              ...
              className="flex items-center justify-between w-full text-xs font-mono text-[#A8B4B7] hover:text-[#D9B96E] py-1 transition"
            >
            ...
            {showRawLogs && (
              <pre className="mt-2 bg-[#06141B] border border-[#1C3945] text-red-300/80 text-xs p-3 rounded-xl overflow-x-auto max-h-36 font-mono scrollbar-thin leading-relaxed whitespace-pre-wrap break-all">

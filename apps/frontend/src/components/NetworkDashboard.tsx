    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[10px] font-mono uppercase tracking-widest px-2.5 py-0.5 rounded-full bg-emerald-950/80 text-emerald-300 border border-emerald-600/40">
              ● Live Telemetry
            </span>
          </div>
        ...
        <button
          ...
          disabled={refreshing}
          className="flex items-center space-x-2 px-3.5 py-2 rounded-xl bg-[#102833] hover:bg-[#1C3945] border border-[#1C3945] hover:border-[#D9B96E]/40 text-[#D9B96E] text-xs font-mono transition shadow-sm self-start sm:self-auto disabled:opacity-50"
        >
        ...
        <div className="bg-[#102833] border border-amber-500/40 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-lg">
          ...
          {onNavigateTab && (
            <button
              ...
              className="flex items-center space-x-1.5 px-4 py-2 bg-gradient-to-r from-[#F0D48D] via-[#D9B96E] to-[#A98A48] text-[#06141B] font-bold text-xs uppercase tracking-wider font-mono rounded-xl shadow-md hover:shadow-lg transition"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[#0D222C]/90 border border-[#1C3945] rounded-2xl p-4 shadow-lg flex items-center space-x-3.5">
          ...
          <div>
            <div className="text-[11px] text-[#A8B4B7] uppercase tracking-wider font-mono">
              Трафик за все время
            </div>
            <div className="text-xl font-bold font-mono text-[#F2F0E8] mt-0.5">
              {stats.total_traffic_formatted}
            </div>
            <div className="text-[10px] text-[#718187] font-mono mt-0.5">
        ...
        <div className="bg-[#0D222C]/90 border border-[#1C3945] rounded-2xl p-4 shadow-lg flex items-center space-x-3.5">
          ...
          <div>
            ...
            <div className="text-xl font-bold font-mono text-[#F2F0E8] mt-0.5">
              {stats.active_users} <span className="text-xs text-[#718187] font-normal">/ {stats.total_users}</span>
            </div>
        ...
        <div className="bg-[#0D222C]/90 border border-[#1C3945] rounded-2xl p-4 shadow-lg flex items-center space-x-3.5">
          ...
          <div>
            ...
            <div className="text-xl font-bold font-mono text-[#F2F0E8] mt-0.5">
              {stats.online_nodes} <span className="text-xs text-[#718187] font-normal">/ {stats.total_nodes}</span>
            </div>
            <div className="text-[10px] text-emerald-400 font-mono mt-0.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#0D222C]/90 border border-[#1C3945] rounded-3xl p-6 shadow-xl flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-[#A8B4B7] font-sans mb-6">
          ...
          <div className="mt-6 pt-4 border-t border-[#1C3945]/80 text-[11px] text-[#718187] font-mono">
        ...
        <div className="lg:col-span-2 bg-[#0D222C]/90 border border-[#1C3945] rounded-3xl p-6 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-mono text-[#A8B4B7]">
            ...
            {(stats.nodes || []).map((n) => (
              ...
              >
                <div>
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center space-x-2.5">
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-[#718187] font-mono">ID #{n.id}</span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-1.5 text-xs font-sans text-[#A8B4B7] bg-[#0A1D26]/70 p-3 rounded-xl border border-[#1C3945]/50">
                    <div className="flex justify-between items-center">
                      <span className="text-[11px] text-[#718187]">Статус:</span>
                      <div className="flex items-center space-x-1.5">
                        <span className={`w-2 h-2 rounded-full ${n.online ? 'bg-emerald-400 animate-pulse' : 'bg-rose-500'}`} />
                        <span className={n.online ? 'text-emerald-400 font-mono text-[11px]' : 'text-rose-400 font-mono text-[11px]'}>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-[11px] text-[#718187]">Задержка:</span>
                      <span className="font-mono text-[11px] text-[#F2F0E8]">{n.latency_ms} ms</span>
                    </div>

                    <div className="flex justify-between items-center">
                      <span className="text-[11px] text-[#718187]">Пиров подключено:</span>
                      <span className="font-mono text-[11px] text-[#D9B96E]">{n.peer_count} устройств</span>
                    </div>

                    <div className="flex justify-between items-center">
                      <span className="text-[11px] text-[#718187]">Трафик узла:</span>
                      <span className="font-mono text-[11px] text-[#F2F0E8]">{n.total_traffic_formatted}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-[#0A1D26]/60 border border-[#1C3945] rounded-3xl p-6 shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-sans text-xs">
          <div className="bg-[#0D222C]/80 p-4 rounded-2xl border border-[#1C3945]/70 flex items-start space-x-3">
            ...
            <div>
              <div className="font-semibold text-sm text-[#F2F0E8]">Обфускация AmneziaWG</div>
              <p className="text-[#A8B4B7] mt-1 leading-relaxed">
          ...
          <div className="bg-[#0D222C]/80 p-4 rounded-2xl border border-[#1C3945]/70 flex items-start space-x-3">
            ...
            <div>
              <div className="font-semibold text-sm text-[#F2F0E8]">Политика No-Logs</div>
              <p className="text-[#A8B4B7] mt-1 leading-relaxed">
          ...
          <div className="bg-[#0D222C]/80 p-4 rounded-2xl border border-[#1C3945]/70 flex items-start space-x-3">
            ...
            <div>
              <div className="font-semibold text-sm text-[#F2F0E8]">Сквозное шифрование</div>
              <p className="text-[#A8B4B7] mt-1 leading-relaxed">
